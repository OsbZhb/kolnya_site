...
import katyaImg from './img/Polina.png';
            ...
            <div className="mastersProfile_block">
                <div className="mastersProfile">
                    ...
                    <div className="masterAbout">
                        <h1>Портфолио мастера<br /> <span>Полины</span></h1>
                        <p className="masterName">ПОЛИНА ГАМОВА</p>
...
export default MastersPage_Polina;