...
import LeraImg from './img/Lera.png';
            ...
            <div className="container">
                ...
                <div className="mastersProfile">
                    ...
                    <div className="masterAbout">
                        <h1>Портфолио мастера<br /> <span>ЛЕРЫ</span></h1>
                        <p className="masterName">Лера Невзорова</p>
...
export default MastersPage_Lera;