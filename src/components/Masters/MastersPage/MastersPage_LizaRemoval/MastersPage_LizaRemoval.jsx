...
import LizaRemovalImg from './img/LizaRemovalImg.png';
...
const MastersPage_LizaRemoval = () => {
    return ( 
        <div className="mastersPage">
            <div className="container">
            <div className="mastersProfile_block">
                <div className="mastersProfile">
                    <img src={LizaRemovalImg} alt="#" />
                    <div className="masterAbout">
                        <h1>Портфолио мастера<br /> <span>ЛИЗЫ</span></h1>
                        <p className="masterName">Лиза Громова</p>
...
export default MastersPage_LizaRemoval;