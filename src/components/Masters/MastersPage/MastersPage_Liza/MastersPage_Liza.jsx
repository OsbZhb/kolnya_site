...
import katyaImg from './img/Liza.png';
            ...
            <div className="container">
                ...
                <div className="mastersProfile">
                    ...
                    <div className="masterAbout">
                        <h1>Портфолио мастера<br /> <span>Елизаветы</span></h1>
                        <p className="masterName">ЕЛИЗАВЕТА ПЕТРОВА</p>
...
export default MastersPage_Liza;